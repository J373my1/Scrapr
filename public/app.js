...
$.getJSON("/articles", function(data) {
  if (data.length !== 0) {
    ...
    var noArticles = $("#articles").append("<h3>Looks like we don't have any articles.</h3>");
  }
});
...
$.getJSON("/saved", function(data) {
  if (data.length !== 0) {
    ...
    var noArticles = $("#savedArticles").append("<h3>Looks like we don't have any articles.</h3>");
  }
});
